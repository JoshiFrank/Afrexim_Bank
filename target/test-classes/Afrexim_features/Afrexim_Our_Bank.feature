...
Scenario: To validate the About Us functionality
...
And Enter telephone with area code "<telephone>"
...
Examples:
|companyname|names|telephone|email|function|organisation|country|requests|
|testcompany|firstname lastname|9876543210|test1@gmail.com|test function|test organisation|test country|test requests|
